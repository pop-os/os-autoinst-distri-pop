...
sub run {
 ...
 # Pop Upgrade
    ...
    assert_and_click 'os_upgrade_screen_recovery_image_download';
    assert_screen 'os_uppgrade_screen_recovery_image_complete',1000;
    assert_screen 'os_uppgrade_screen_recovery_refresh_available',1000;
    assert_and_click 'os_upgrade_confirm_refresh';
